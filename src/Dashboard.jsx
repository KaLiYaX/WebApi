function Dashboard({ user }) {
    ...
    const toggleApiKeyPause = async () => {
        ...
        try {
            ...
            alert(newStatus ? 'API Key paused ⏸️' : 'API Key resumed ▶️');
        } catch (error) {
    ...
    const handleTabChange = (tab) => {
        setActiveTab(tab);
        setShowMenu(false); // Auto hide menu after selection
    };
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex items-center justify-center px-4">
                <div className="text-center max-w-md">
                    ...
                    <a 
                        href="https://wa.me/94771198299?text=Please%20KX,%20Release%20My%20Api%20User%20Account%20😿"
                        target="_blank"
